...
use binette::local_access::{
    ...
    BINETTE_LOCAL_SEQUENCE_THUNK, BINETTE_LOCAL_VARIANT_PAYLOAD_NEWTYPE, BinetteLocalDescriptorAbi,
    BinetteLocalEnumAbi, BinetteLocalEnumTagAccessAbi, BinetteLocalEnumTagThunkAbi,
    BinetteLocalExternalAbi, BinetteLocalExternalMetadataAbi, BinetteLocalKindAbi,
    BinetteLocalLayoutAbi, BinetteLocalOptionAbi, BinetteLocalOptionRepresentationAbi,
    BinetteLocalOptionThunksAbi, BinetteLocalScalarAbi, BinetteLocalSchemaRefAbi,
    BinetteLocalSequenceAbi, BinetteLocalSequenceStorageAbi, BinetteLocalSequenceThunksAbi,
...
fn c_abi_descriptor_drives_hybrid_local_enum_message_stencil() {
    ...
    let variants = [
        BinetteLocalVariantAbi {
            ...
            payload_kind: BINETTE_LOCAL_VARIANT_PAYLOAD_NEWTYPE,
...
fn c_abi_sequence_storage_empty() -> BinetteLocalSequenceStorageAbi {
    BinetteLocalSequenceStorageAbi {
        ...
        thunks: BinetteLocalSequenceThunksAbi {
            ...
            element_u8: None,
            element_ptr: None,
            element_project_into: None,
            element_drop_projected: None,
            write_bytes: None,
